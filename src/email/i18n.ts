...
export const getMessages: GetMessages = (props) => {
	...
	return {
		...
		'requiredAction.TERMS_AND_CONDITIONS': t(
		...
		'linkExpirationFormatter.timePeriodUnit.seconds': t(
			'requiredAction.seconds'
		),
		'linkExpirationFormatter.timePeriodUnit.minutes': t(
			'requiredAction.minutes'
		),
